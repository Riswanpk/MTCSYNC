...
class _InAppVideoPlayerDialog extends StatefulWidget {
  final String videoUrl;
  const _InAppVideoPlayerDialog({required this.videoUrl});

  @override
  State<_InAppVideoPlayerDialog> createState() => _InAppVideoPlayerDialogState();
}

class _InAppVideoPlayerDialogState extends State<_InAppVideoPlayerDialog> {
