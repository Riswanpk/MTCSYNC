...
class _DmeUserDashboardPageState extends State<DmeUserDashboardPage> {
  ...
  Future<void> _init() async {
    ...
    if (widget.dmeUser.branchId != 0 && !_userBranchIds.contains(widget.dmeUser.branchId)) {
      _userBranchIds.add(widget.dmeUser.branchId);
    }
  ...
  List<int>? _effectiveBranchIds() {
    ...
    // non-admin "All assigned" → their branch IDs ([-1] if none assigned to prevent full DB leakage)
    return _userBranchIds.isEmpty ? [-1] : _userBranchIds;
  }
