...
class _DmeCustomerListPageState extends State<DmeCustomerListPage> {
  final _svc = DmeCustomerService.instance;
  ...
  Future<void> _init() async {
    _branchIds = await _userSvc.getUserBranchIds(widget.dmeUser.id);
