...
import '../../dashboard/services/dme_dashboard_service.dart';
...
class _DmeCustomerVisitAnalyticsPageState
  ...
  final _svc = DmeDashboardService.instance;
  final _baseSvc = DmeMtcSupabaseService.instance;
  ...
  Future<void> _loadBranches() async {
    try {
      final branches = await _baseSvc.getBranches();
      if (mounted) {
        setState(() {
          _branches = branches;
